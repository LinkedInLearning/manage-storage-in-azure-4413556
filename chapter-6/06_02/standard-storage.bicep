...
resource blobService 'Microsoft.Storage/storageAccounts/blobServices@2022-09-01' = {
  ...
  resource containerBlobDemo 'containers' = {
    name: 'blobsoftdelversion'
  }

  resource containerDel 'containers' = {
    name: 'containersoftdel'
  }
}
...
resource deploymentScript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    scriptContent: '''
                        ...
                        az storage blob upload --file blob1.txt --container-name blobsoftdelversion --name blob1.txt

                        az storage blob upload --file blob1.txt --container-name containersoftdel --name blob2.txt

                        az storage blob upload --file blob2.json --container-name blobsoftdelversion --name blob1.json

                        az storage blob upload --file blob2.json --container-name containersoftdel --name blob2.json
                  '''
  }
}
